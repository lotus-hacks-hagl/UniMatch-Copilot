...
async def submit_crawl(body: CrawlJobRequest):
    ...
    await create_job(body.job_id, "crawl_university", body.callback_url, body.model_dump(mode="json"))
...
async def submit_analyze(body: AnalyzeJobRequest):
    ...
    """
    await create_job(body.job_id, "analyze_profile", body.callback_url, body.model_dump(mode="json"))
