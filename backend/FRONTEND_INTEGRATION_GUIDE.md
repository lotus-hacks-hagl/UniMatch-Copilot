...
- **Base URL**: `http://localhost:8080/api/v1` (Mặc định cho local)
- **Swagger UI**: `http://localhost:8080/swagger/index.html` (Xem chi tiết Models, tham số truyền vào).
...
1. Đọc file `internal/dto` hoặc truy cập Swagger `localhost:8080/swagger` để copy/paste y nguyên format Input vào Typescript Interfaces của bạn. 
